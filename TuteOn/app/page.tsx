            ...
            <div className="grid gap-8 md:grid-cols-3">
              <Card className="bg-background/60 backdrop-blur-sm border-muted/50 hover:shadow-lg transition-all hover:border-blue-500/50">
                <CardContent className="pt-6">
                  ...
                  <h3 className="mb-2 text-xl font-bold">Verified Leads</h3>
                  <p className="text-muted-foreground">
                    Access high-quality student requests. Phone numbers are securely stored and only revealed when you choose to connect.
                  </p>
                </CardContent>
              </Card>
